...
function MedalsDisplay:new()
    ...
    instance:addItem(Overlay:new("backgroundOverlay", "data/missions/medals_background.png", 0.05, instance.posY, 0.9, instance.height));
    instance:addItem(Overlay:new("bronzeMedalOverlay", "data/missions/bronze_medal.png", instance.posX+instance.medalsSpacingX*2, instance.medalsPosY, instance.medalsHeight*0.75, instance.medalsHeight));
    instance:addItem(Overlay:new("silverMedalOverlay", "data/missions/silver_medal.png", instance.posX+instance.medalsSpacingX*1, instance.medalsPosY, instance.medalsHeight*0.75, instance.medalsHeight));
    instance:addItem(Overlay:new("goldMedalOverlay", "data/missions/gold_medal.png", instance.posX+instance.medalsSpacingX*0, instance.medalsPosY, instance.medalsHeight*0.75, instance.medalsHeight));
...
function MedalsDisplay:renderText(time, x, y, fs)
    local timeHoursF = time/(1000*60)+0.0001;
    local timeHours = math.floor(timeHoursF);
    local timeMinutes = math.floor((timeHoursF-timeHours)*60);
    --renderText(x, y, fs, string.format("%02d:%02d Minuten", timeHours, timeMinutes));
...
function MedalsDisplay:setTimes(bronzeTime, silverTime, goldTime)

...
function InGameMenu:new()
    ...
    -- In Game
    local ingame_menu_sizeX = 0.3;
    local ingame_menu_spaceX = 0.03;
    local ingame_menu_sizeY = 0.06;
    local ingame_menu_posX = 0.021;
    local ingame_menu_posY = 0.02;
    self.inGameMenu = OverlayMenu:new();

    instance.overlay_restart = Overlay:new("ingame_menu_button", "data/menu/ingame_menu_restart".. g_languageSuffix .. ".png", ingame_menu_posX+ingame_menu_spaceX*0+ingame_menu_sizeX*0, ingame_menu_posY, ingame_menu_sizeX, ingame_menu_sizeY);
    instance.overlay_save = Overlay:new("ingame_menu_button", "data/menu/ingame_menu_save".. g_languageSuffix .. ".png", ingame_menu_posX+ingame_menu_spaceX*0+ingame_menu_sizeX*0, ingame_menu_posY, ingame_menu_sizeX, ingame_menu_sizeY);
    instance.overlay2 = Overlay:new("ingame_menu_button", "data/menu/ingame_menu_cancel".. g_languageSuffix .. ".png", ingame_menu_posX+ingame_menu_spaceX*1+ingame_menu_sizeX*1, ingame_menu_posY, ingame_menu_sizeX, ingame_menu_sizeY);
    instance.overlay3 = Overlay:new("ingame_play_button", "data/menu/ingame_menu_continue".. g_languageSuffix .. ".png", ingame_menu_posX+ingame_menu_spaceX*2+ingame_menu_sizeX*2, ingame_menu_posY, ingame_menu_sizeX, ingame_menu_sizeY);

    instance.savingOverlay = Overlay:new("ingame_saving", "data/menu/ingame_menu_saving".. g_languageSuffix .. ".png", ingame_menu_posX+ingame_menu_spaceX*0+ingame_menu_sizeX*0, ingame_menu_posY+0.07, ingame_menu_sizeX, ingame_menu_sizeY);

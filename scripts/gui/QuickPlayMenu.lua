...
function QuickPlayMenu:new(backgroundOverlay)
    ...
    repeat
        ...
        _=[[local savegame = {};
        local baseXMLName = "savegames.quickPlay.savegame"..i;
        ...
        if savegame.valid ~= nil then
            ...
            table.insert(instance.savegames, savegame);
        else
            eof = true;
        end;]]
        i = i+1;
    ...
    instance:addButton(OverlayButton:new(Overlay:new("up_button", "data/menu/up_button.png", 0.5-0.5*instance.buttonWidth, 1-instance.upDownButtonSpacing-instance.buttonHeight, instance.buttonWidth, instance.buttonHeight), OnQuickPlayMenuScrollUp));
    instance:addButton(OverlayButton:new(Overlay:new("down_button", "data/menu/down_button.png", 0.5-0.5*instance.buttonWidth, instance.upDownButtonSpacing+instance.backPlayButtonSpacing+instance.buttonHeight, instance.buttonWidth, instance.buttonHeight), OnQuickPlayMenuScrollDown));

    local buttonSpacingSide = 0.03
    local xPos = 1-buttonSpacingSide-instance.backPlayButtonSpacing-instance.buttonWidth*2  --0.65;
    instance:addButton(OverlayButton:new(Overlay:new("back_button", "data/menu/back_button".. g_languageSuffix .. ".png", xPos, instance.backPlayButtonSpacing, instance.buttonWidth, instance.buttonHeight), OnQuickPlayMenuBack));
    xPos = xPos + instance.buttonWidth+instance.backPlayButtonSpacing;
    instance:addButton(OverlayButton:new(Overlay:new("play_button", "data/menu/ingame_play_button".. g_languageSuffix .. ".png", xPos, instance.backPlayButtonSpacing, instance.buttonWidth, instance.buttonHeight), OnQuickPlayMenuPlay));
    xPos = xPos + instance.buttonWidth+instance.backPlayButtonSpacing;

    instance:addButton(OverlayButton:new(Overlay:new("delete_button", "data/menu/delete_button".. g_languageSuffix .. ".png", buttonSpacingSide, instance.backPlayButtonSpacing, instance.buttonWidth, instance.buttonHeight), OnQuickPlayMenuDelete));
    instance:addButton(OverlayButton:new(Overlay:new("reset_vehicles_button", "data/menu/reset_vehicles_button".. g_languageSuffix .. ".png", buttonSpacingSide+instance.buttonWidth+instance.backPlayButtonSpacing, instance.backPlayButtonSpacing, instance.largeButtonWidth, instance.buttonHeight), OnQuickPlayMenuResetVehicles));
...
function QuickPlayMenu:startSelectedGame()
...
function QuickPlayMenu:writeVehicleListToFile(file, list)
